...
cl = LINETCR.LINE()
cl.login(token="EsdnQOFkXfxEkXWNfsld.uuS4VlyaKSSu/iQq4H5nxq.eZh4tIcmA7fI7VYm48kNltn+KdJ1/RFbvqN5Sv1PbXE=")
cl.loginResult()

#ki1 = LINETCR.LINE()
#ki1.login(token="ErtfKxnhUH4K8iQ3Jy53.GLoAPUWtFWBdZrXMVnjSiW.7iDWJBVPIBGhQn/U4l4Jo0ZT7DnB1gPKpKt/BFvb6wk=")
#ki1.loginResult()

#ki2 = LINETCR.LINE()
#ki2.login(token='Era84zqgdz0Y5a6jBikb.JmKQqtjNPq+gtvhYJBOJIW.rny32a7j4g66rZWxZ4EW+z8k2uSSSTnwNuJ9Bd5RRws=')
#ki2.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u514b38bcb60092cb14f88a90e21e4d5d",mid]
self = ["u514b38bcb60092cb14f88a90e21e4d5d",mid]
admin = "u514b38bcb60092cb14f88a90e21e4d5d"
admsa = "u514b38bcb60092cb14f88a90e21e4d5d"
owner = "u514b38bcb60092cb14f88a90e21e4d5d"
adminMID = "uffa94e0c3182b3db2bfd6ecc821fa8bc"
Creator="uffa94e0c3182b3db2bfd6ecc821fa8bc"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
...
#----------------------------------------------------------------------------
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line http://line.me/ti/p/12312121...")
