...
cl = LINETCR.LINE()
cl.login(token="Eslc8cfKq3ooSlPhbga2.fnB9tPezch+ls27FD/xbSG.R+6xXkHvKLRmb4vOMndCEfyGnv9XC53WW6CCkO5eUCk=")
cl.loginResult()

#ki1 = LINETCR.LINE()
#ki1.login(token="EsxMJQa6e24Z2pg7Fg4f.nD4zxSyKNPE92+6F7eBYFW.Q8hF7V2xix8DlrY6c+b5qBAT22EJncntAk05WKxT/zw=")
#ki1.loginResult()

#ki2 = LINETCR.LINE()
#ki2.login(token='Eslg0qlipII1ium9DFX3.7hAloeGetQxHLF4l+0VbiW./U2qZ5HTr5sskiQCa2tceoOF+6rTkoRWi/WomJ//TEE=')
#ki2.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u14d6fd4e9119087fcb4b6edf77e5c1b2",mid]
self = ["u14d6fd4e9119087fcb4b6edf77e5c1b2",mid]
admin = "u14d6fd4e9119087fcb4b6edf77e5c1b2"
admsa = "u14d6fd4e9119087fcb4b6edf77e5c1b2"
owner = "u14d6fd4e9119087fcb4b6edf77e5c1b2"
adminMID = "u14d6fd4e9119087fcb4b6edf77e5c1b2"
Creator = "u14d6fd4e9119087fcb4b6edf77e5c1b2"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
...
#----------------------------------------------------------------------------
                ...
                msg.contentType = 13
                adm = 'uda039cff4839b44d2f9b421c950fe846'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line http://line.me/ti/p/~chindo321")
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
                        ...
                        ki1.sendText(msg.to,"[By:ชินจัง|| ]")
                        ki2.sendText(msg.to,"[Do not think  will try.]")
                        ki3.sendText(msg.to,"[ By:ชินจัง| ]")
...
#========================================
                ...
                if wait["clock"] == True: md+="􀬁􀆐?? ชื่อ นาฬิกา : ✔ 􀜁􀄯􏿿\n"
...
#==============================================================================#
            ...
            elif msg.text in ["เปิดอ่าน","RR","ตั้งเวลา"]:
                        cl.sendText(msg.to,"lurk on")
            elif msg.text in ["ปิดอ่าน","R off"]:
                        cl.sendText(msg.to,"lurk off")
            elif msg.text in ["ใครอ่าน","yy"]:
                        cl.sendText(msg.to,"คนอ่านอยู่นี่")
            elif msg.text in ["Ry"]:
                        cl.sendText(msg.to,"lurkers")
                        cl.sendText(msg.to,"lurkers")
                        cl.sendText(msg.to,"lurkers")
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cl.sendMessage(cnt)
                        ...
                        cl.sendText(msg.to,"มองยุได้แอบชอบเค้าอะดิ้><")

            elif msg.text in ["/ลบรัน"]:
                        cl.sendText(msg.to,"ลบรัน")

            elif msg.text in ["อยุ่ไหม"]:
                        cl.sendText(msg.to,"อยุ่ไม่อยุ่ก็เรื่องของกุ....😂")

            elif msg.text in ["/ออน"]:
                        cl.sendText(msg.to,"ออน")

            elif msg.text in ["555"]:
                        cl.sendText(msg.to,"ขําไรวะขําด้วยคนดิ..555")
